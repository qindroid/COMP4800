...
const Utils = {
  ...
  SendResult: function (res, data) {
    let result = {
      code: errHandler.error_success.code,
      message: errHandler.error_success.message,
    };
  ...
  SendError: function (res, err) {
    let result = {
      code: err && err.code ? err.code : errHandler.error_unknown.code,
      message:
        err && err.message ? err.message : errHandler.error_unknown.message,
    };
    res.send(result);
  },
